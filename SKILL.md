...
description: "**Consulting Problem Solving Framework**."
---
...
| 8. Communicate | Slide content (.md) or approved vertical content (.md) | [08-communicate.md](references/08-communicate.md) + [08-slides-content.md](references/08-slides-content.md) + [08-slide-content-format.md](references/08-slide-content-format.md) or [08-vertical-content.md](references/08-vertical-content.md) |
